...
- [`[딥러닝 가속기 (NPU)]`](@/studynote/1_computer_architecture/12_accelerators_ai/_index.md): 현대 아키텍처가 AI 워크로드를 처리하기 위해 진화한 도메인 특화 구조(DSA).
- [`[암달의 법칙 (Amdahl's Law)]`](@/studynote/1_computer_architecture/3_architecture_performance/_index.md): 병렬화를 통한 성능 향상의 한계를 정의하는 핵심 수학 공식.
