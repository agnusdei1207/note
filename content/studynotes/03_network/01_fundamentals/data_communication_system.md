+++
title = "데이터통신 시스템 구성요소 (DTE, DCE, CCU)"
date = 2024-05-18
description = "데이터통신 시스템의 핵심 구성요소인 DTE, DCE, CCU의 역할과 상호동작 메커니즘을 심도 있게 분석합니다."
weight = 10
[taxonomies]
categories = ["studynotes-03_network"]
tags = ["DTE", "DCE", "CCU", "DataCommunication", "Network"]
+++
...
- **체크리스트**:
  - DCE 장비의 클럭 동기화(Clock Synchronization) 설정 확인
  - DTE-DCE 간 케이블 핀아웃(Pinout) 검증 (Straight-through vs Cross-over)
  - 하드웨어 흐름 제어(RTS/CTS) 활성화 여부 확인
  - 인터페이스 표준(RS-232C, V.35, X.21) 호환성 검증
...
### ※ 참고 표준/가이드
- **EIA RS-232C**: Interface Between Data Terminal Equipment and Data Circuit-Terminating Equipment
- **ITU-T V.35**: Data Transmission at 48 Kilobits per Second
- **ITU-T X.21**: Interface Between DTE and DCE for Synchronous Operation
- **ISO 2110**: Data Communication - 25-Pin DTE/DCE Interface Connector

---

## 📌 관련 개념 맵 (Knowledge Graph)
- [OSI 7계층](@/studynotes/03_network/01_fundamentals/osi_7_layer.md): DTE, DCE, CCU가 각각 동작하는 계층의 이해
- [물리 계층 인코딩](@/studynotes/03_network/01_fundamentals/_index.md): DCE가 수행하는 NRZ, Manchester 부호화 기법
- [오류 제어 기법](@/studynotes/03_network/01_fundamentals/_index.md): CCU가 수행하는 ARQ, FEC 메커니즘
- [직렬 통신 프로토콜](@/studynotes/03_network/01_fundamentals/_index.md): RS-232C, USB, SATA 등 DTE-DCE 인터페이스
- [네트워크 인터페이스 카드](@/studynotes/03_network/01_fundamentals/_index.md): 현대적 DCE의 대표적 예시
