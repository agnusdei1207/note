...
| 구성 요소 | 역할 | 예시 |
|----------|------|------|
| System Prompt | AI 역할·행동 지침 정의 | "당신은 PE 시험 전문가입니다" |
...
> **결론**: 프롬프트 엔지니어링은 LLM 시대의 핵심 스킬. Zero-shot→CoT→ReAct 순으로 복잡도에 맞게 적용하고, DSPy로 자동화까지 나아가는 것이 2025년 실무 표준이다. PE는 비즈니스 목표에 맞는 프롬프트 전략 설계와 프롬프트 인젝션 보안까지 설계할 수 있어야 한다.  
