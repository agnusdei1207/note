...
> **결론**: LoRA/QLoRA는 "LLM 특화의 민주화" — 소규모 팀도 RTX 4090 한 장으로 전문 LLM 구축 가능하게 했다. 2024년 DPO가 RLHF를 대체하며 정렬 파인튜닝의 표준이 되었다. PE는 데이터 품질·LoRA 설정·Catastrophic Forgetting 방지·DPO 활용을 설계할 수 있어야 한다.
