...
## 핵심 인사이트 (3줄 요약)
> **소프트웨어 시스템을 시각화하는 표준 모델링 언어**. 구조 다이어그램(클래스·컴포넌트)과 행위 다이어그램(시퀀스·유스케이스·상태)으로 분류. PE 시험에서 다이어그램 종류와 목적을 명확히 구분해야 한다.
...
> 소프트웨어 시스템을 시각화하는 표준 모델링 언어. 구조 다이어그램(클래스·컴포넌트)과 행위 다이어그램(시퀀스·유스케이스·상태)으로 분류. PE 시험에서 다이어그램 종류와 
