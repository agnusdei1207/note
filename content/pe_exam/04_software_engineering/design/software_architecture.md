...
## 핵심 인사이트 (3줄 요약)
> **시스템 전체 구조를 결정하는 고수준 설계 패턴**. 계층형·MVC·마이크로서비스·이벤트 드리븐 등 주요 패턴이 있다. PE 시험에서는 각 패턴의 특징과 적합한 상황을 비교해서 설명해야 한다.
...
- **핵심 포인트**: MSA vs 모놀리식 trade-off, 각 패턴 적합 케이스
...
> 시스템 전체 구조를 결정하는 고수준 설계 패턴. 계층형·MVC·마이크로서비스·이벤트 드리븐 등 주요 패턴이 있다. PE 시험에서는 각 패턴의 특징과 적합한 상황을 비교해서
