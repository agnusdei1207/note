+++
weight = 387
title = "387. Top-K / Top-P (Nucleus Sampling) - 샘플링 디코딩 확률 분포 커트라인"
date = "2026-04-21"
[extra]
...
**η-샘플링 (Epsilon Sampling)**: 확률 ε 이하 토큰 제거 (Top-P의 절대값 버전)
**Typical Sampling**: 정보 이론적 전형성(Typicality)으로 후보 선택
...
**코드 생성**: Temperature=0.2, Top-P=0.95 또는 Greedy
