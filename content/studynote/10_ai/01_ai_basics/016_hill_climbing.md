...
|:---|:---|:---|:---|:---|
| **기억 장소 (Memory)** | O(1) (현재 상태만 유지) | O(b^d) (모든 프론티어 유지) | O(1) | **자원 제약 환경**에서 Hill Climbing이 압도적 유리 |
| **해 보장 (Optimality)** | 미보장 (지역 최적해 위험) | 보장 (허용적 휴리스틱 조건 시) | 확률적 보장 (온도 스케줄링) | 정확도가 생명인 경우 배제 |
| **탐색 유연성** | 전혀 없음 (오르막만 허용) | 완전성 지향 | 유연함 (초기엔 내리막 허용) | **노이즈 많은 환경**에서 SA 채택 |
