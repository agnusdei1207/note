+++
weight = 263
title = "263. K-Means 군집화 - 중심점 거리 반복 이동 / EM 구조"
date = "2026-04-21"
[extra]
...
| K-Means++ | 확률적 초기화, 지역 최적해 | K-Means 초기화 개선 |
| DBSCAN | 밀도 기반, 임의 형태 | K-Means 한계를 극복하는 대안 |
| Mini-Batch K-Means | 온라인 학습, 대규모 데이터 | 확장 가능한 K-Means 변형 |
