+++
weight = 339
title = "339. Word2Vec - CBOW와 Skip-Gram 단어 벡터 밀집 표현"
date = "2026-04-21"
[extra]
...
### 👶 어린이를 위한 3줄 비유 설명
- 📍 Word2Vec 은 단어마다 "지도의 좌표"를 부여해서, 비슷한 단어는 좌표가 가깝게 만들어요.
- 🔍 Skip-Gram 은 "사과"라는 단어를 보면 주변에 "과일", "빨간색", "맛있다"가 올 거라고 예측해서 단어의 의미를 배워요.
- ✨ 그래서 "왕 - 남자 + 여자" 계산을 하면 "여왕"이 나오는 신기한 수학이 가능해요!
