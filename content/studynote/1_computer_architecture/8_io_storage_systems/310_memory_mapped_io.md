...
```text
[S/W App] -> [OS Kernel] -> [Device Driver] -> [MMIO Access]
                                    │
                                    ▼
                          ┌──────────────────┐
                          │ Check Status Reg │ <── (Read MMIO)
                          └────────┬─────────┘
                                   │ Is Ready?
                          ┌────────┴─────────┐
                          │ Write Data Reg   │ <── (Write MMIO)
                          └──────────────────┘
```
...
```text
[Parallel Bus] -----> [Serial PCIe] -----> [Unified CXL Fabric]
(Low Speed)          (High Throughput)     (Memory & Cache Coherent)
    1990s                2010s                 2025+
```
