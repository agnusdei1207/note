...
따라서 핵심 원리는 "많이 흐르게 하라"가 아니라 **필요한 곳에 필요한 만큼만 안정적으로 흐르게 하라**다. 그래서 전력망 메쉬, 디커플링 커패시터, 전류 제한, 파워 게이팅이 모두 전류 설계의 일부가 된다.
...
실무에서는 전류를 직접 보는 순간이 많다. 서버 보드에서는 피크 전류 때문에 전압 강하가 생기고, 모바일 칩에서는 누설 전류 때문에 대기 전력이 커진다. 따라서 전류 문제를 만나면 "몇 암페어가 흐르나"보다 먼저 **언제, 어디서, 왜 몰리는가**를 봐야 한다.
