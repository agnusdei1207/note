...
- **概念**: 1-주소 명령어는 '지정석이 있는 식당'이다. 손님이 한 명(1-주소) 들어오면 "어디 앉을까요?" 묻지 않는다. 무조건 정해진 VIP석(누산기)에 앉아있는 사람과 합석해서 식사(연산)를 하고, 남은 음식(결과)도 무조건 그 VIP석에 두고 떠나는 철저한 고정형 시스템이다.
- **💡 비유**: 1-주소 명령어는 '도마 하나뿐인 주방'과 같다. "당근(1-주소) 썰어!"라고 하면, 주방장(ALU)은 무조건 하나뿐인 도마(누산기) 위에 당근을 올려놓고 썬다. 모든 요리 결과물은 항상 그 유일한 도마 위에 남게 된다.
- **등장 배경**: 
