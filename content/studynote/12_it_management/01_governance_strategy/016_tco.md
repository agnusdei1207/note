...
date = "2024-05-20"
[taxonomies]
tags = ["TCO", "CAPEX", "OPEX", "IT투자평가", "IT경영"]
...
| **직접 비용 (Direct)** | IT 예산으로 명확하게 추적 가능한 예산 항목 (인건비 포함) | 부서 예산 코드로 할당됨 | ITSM 도입을 통한 인력 효율화 | 정비소 수리 영수증 |
| **간접 비용 (Indirect)**| 현업 사용자의 다운타임 손실, 자가 지원(Self-support) 비효율 | 추정 모델링 필요 (ABC 원가계산) | SLA(서비스 수준 협약) 가용성 보장 | 고장으로 지각하여 발생한 손실 |
