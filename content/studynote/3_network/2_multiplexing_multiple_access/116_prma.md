...
| **VAD (Voice Activity Detection)** | 음성 활성화 감지 모듈 | 사용자의 발화 구간과 묵음 구간을 식별하여 패킷 생성 제어 | 손님의 식사/대기 상태 |
...
| **음성 QoS 지원** | 완벽 보장 | 보장 불가 (충돌 지연) | 보장 (예약 성공 이후) |
...
| **QoS 보장** | 경쟁 후 즉각적인 슬롯 예약을 통해 음성 통신의 최대 지연 시간 엄격히 제한 가능 |
