...
> 2. **가치**: 적절한 자료구조 선택은 알고리즘 성능을 결정적으로 좌우하며, 부적절한 선택은即使是 정렬된 알고리즘도非효율적으로 만든다.
...
3. 그런데 가장 좋은 정리법은 없어요. 새로 넣을 때는 아무렇게나 쌓아두는 게 빠르지만, 찾을 때는 분류가 필요하거든요. 그래서場合마다 다른 자료구조를 써야 해요!
