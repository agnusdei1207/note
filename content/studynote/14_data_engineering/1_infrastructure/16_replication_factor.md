...
date = "2025-01-01"
[taxonomies]
tags = ["HDFS", "Hadoop", "Replication", "Fault Tolerance", "Big Data"]
...
**심층 동작 원리**
1. **파이프라인 할당**: 클라이언트는 네임노드에게 128MB 블록을 쓸 3개의 데이터노드를 요청합니다.
...
**실무 의사결정 시나리오**
1. **임시 중간 데이터 (Temporary/Shuffle Data) 적재 시**
