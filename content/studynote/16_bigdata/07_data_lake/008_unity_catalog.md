...
2. **컬럼/행 수준의 세밀한 접근 제어(Fine-Grained Access Control)**, **데이터 리니지 자동 추적**, **감사 로그**를 제공하여 GDPR, HIPAA, SOC2 규정 준수를 지원한다.
3. **Delta Sharing**은 Unity Catalog 위의 오픈 프로토콜로, 데이터를 복사하지 않고 다른 클라우드·플랫폼의 소비자와 안전하게 공유할 수 있다.
