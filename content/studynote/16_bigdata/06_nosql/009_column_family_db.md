...
| **LCS** (Leveled Compaction Strategy) | 레벨별 정렬 유지 | 읽기 집중 |
...
### 결론
컬럼 패밀리 DB는 시계열·이벤트 중심의 대용량 데이터에서 타 NoSQL 모델보다 압도적인 쓰기 성능을 제공한다. 기술사 시험에서는 **Cassandra의 마스터리스 링 구조와 튜너블 일관성**, **HBase의 ZooKeeper 기반 강한 일관성 메커니즘**, **TWCS Compaction 전략의 시계열 최적화 원리**가 핵심 논점이다.
