...
### 결론
Elasticsearch/OpenSearch는 로그 분석·전문 검색·실시간 집계를 단일 플랫폼으로 통합하는 현대 옵저버빌리티의 핵심 인프라다. 기술사 시험에서는 **역색인 원리와 Inverted Index 구조**, **BM25 관련성 스코어링**, **Primary/Replica 샤드 아키텍처**, **Bool 쿼리와 Aggregation 활용**이 핵심 논점이다.
