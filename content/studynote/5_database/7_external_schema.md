...
date = "2024-05-20"
[taxonomies]
tags = ["Database", "Schema", "External Schema", "ANSI-SPARC", "View"]
...
|:---|:---|:---|:---|:---|
| **View Definition** | 가상 테이블 정의 | SELECT 쿼리를 딕셔너리에 저장하고 런타임에 전개 | CREATE VIEW | 맞춤형 필터 안경 |
| **Query Parser** | 사용자 질의 분석 | 외부 질의를 개념 스키마 질의로 치환 | Query Rewriting | 통역사 |
| **Catalog Access** | 메타데이터 조회 | 권한 및 매핑 규칙, 컬럼 무결성 확인 | Dictionary Cache | 신원 조회기 |
| **Access Control** | 보안 검증 | 뷰에 정의된 열과 행에 대한 접근 인가 | GRANT, REVOKE | 출입증 확인 |
