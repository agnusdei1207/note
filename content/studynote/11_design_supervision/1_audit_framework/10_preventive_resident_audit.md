...
date = "2024-05-24"
[taxonomies]
tags = ["예방 감리", "상주 감리", "Preventive Audit", "Resident Audit", "정보시스템 감리", "PMO"]
...
| **이해관계자 신뢰 구축** | 발주처에 블랙박스 없는 투명한 가시성(Visibility)을 매주 제공 |
| **사업자 기술력 상향** | 상주 기술사의 상시 멘토링을 통한 사업자 개발팀의 시큐어 코딩 및 아키텍처 역량 동반 상승 |
