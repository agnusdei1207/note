...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: 3C 분석(3C Analysis)은 Customer(고객)·Competitor(경쟁자)·Company(자사)의 세 관점을 통합하여 전략적 포지셔닝을 도출하는 프레임워크다. 오마에 겐이치(大前研一)가 제시한 경영 전략 기법이다.
...
| C | 분석 항목 |
|:---|:---|
| **Customer** | 고객 세그먼트, 니즈, 구매 기준, 불만, 트렌드 |
