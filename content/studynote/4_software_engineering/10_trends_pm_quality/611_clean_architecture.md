...
1. **SOLID 원칙**: 특히 DIP(의존성 역전)이 클린 아키텍처의 핵심

2. **헥사고날 아키텍처**: 포트 & 어댑터 패턴 기반

3. **도메인 주도 설계**: 전술적 패턴이 클린 아키텍처와 완벽 조화

4. **CQRS**: 읽기/쓰기 분리와 클린 아키텍처의 결합

5. **이벤트 소싱**: 상태 저장 대신 이벤트 스트림 저장
