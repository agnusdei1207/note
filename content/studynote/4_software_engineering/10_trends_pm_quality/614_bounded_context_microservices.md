...
- **도메인 주도 설계 (DDD)**: DDD 전술적 패턴 (Entity, Value Object, Aggregate)과 바운디드 컨텍스트의 관계
- **애그리게이트 루트**: 트랜잭션 경계와 BC의 관계
- **마이크로서비스 아키텍처**: MSA 전체 아키텍처와 BC의 위치
- **CQRS**: BC 내부의 조회/명령 분리 패턴
- **사가 패턴**: BC 간 분산 트랜잭션 관리
