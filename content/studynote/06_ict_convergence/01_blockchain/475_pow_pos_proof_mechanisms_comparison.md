...
> 2. **가치**: 이더리움 The Merge(2022.09)로 PoW → PoS 전환 후 에너지 소비가 **99.95% 감소**했으며, 이는 탄소 중립 블록체인 설계의 기준이 됐다.
...
1. **탈중앙화 극대화 필요**: PoW → 채굴 분산도 측정 지표(Nakamoto 계수) 활용
2. **에너지 효율 / ESG 규제**: PoS → 탄소 발자국 최소화
3. **빠른 최종성 필요**: PoS Tendermint/Ethereum → 결정적 최종화
4. **하드웨어 ASIC 집중화 위험**: PoW의 고질적 문제, PoS로 완화
...
| 최종성(Finality) | PoW 확률적 vs PoS 결정적 차이 |
