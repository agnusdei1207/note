...
1. **적대적 예제**: 모델 추론 과정을 공격 — "무엇을 판단하느냐"를 속임
...
2. **감사 가능성(Auditability)**: ε 계산 결과와 훈련 로그를 함께 보존 → 규제 감사 대응
3. **적대적 예제 + DP 결합**: DP 노이즈가 적대적 예제 방어에도 일부 기여 — 완전한 방어는 아님
