...
전이 행렬 P의 **정상 분포 π**는 π = πP를 만족하는 확률 벡터.
...
마르코프 체인은 기억상실 개구리가 연못에서 수련잎을 뛰어다니는 것처럼, 지금 어느 잎에 있는지만 보고 다음 잎으로 점프하는 방식이야.
흡수 상태는 개구리가 빠지면 절대 못 나오는 함정 잎이야 — 한 번 빠지면 끝!
에르고딕 체인은 계속 뛰다 보면 결국 어느 잎에 제일 많이 있게 되는지 알 수 있어 — 그게 바로 정상 분포야!
