...
| 개념 | 연결 포인트 |
|:---|:---|
| **라스베이거스 알고리즘 (Las Vegas Algorithm)** | 항상 정확한 해를 반환하되 실행 시간이 확률적으로 결정되는 유형 |
| **몬테카를로 알고리즘 (Monte Carlo Algorithm)** | 고정된 시간 내에 확률적 정확도로 해를 반환하는 유형 |
| **CSPRNG (Cryptographically Secure Pseudorandom Number Generator)** | 보안 응용에서 반드시 사용해야 하는 암호학적으로 안전한 난수 생성기 |
